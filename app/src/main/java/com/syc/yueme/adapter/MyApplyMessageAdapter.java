...
/**
 * Created by kawhi on 15/3/10.
 */
public class MyApplyMessageAdapter extends BaseListAdapter<AVObject>{
    ...
    public MyApplyMessageAdapter(Context ctx) {
        super(ctx);
        init();
    }
    ...
    public MyApplyMessageAdapter(Context ctx, List<AVObject> datas) {
        super(ctx, datas);
        init();
    }
